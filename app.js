...
(function () {
  ...
  const originalCars = [
    makeCar("GPS-021","تويوتا هايلكس 2023","مركبة خدمات","د ب س 2841","D-101","Test1","moving",56,73,41280,74.6,"central",1,18),
    makeCar("GPS-034","هيونداي H1 2022","نقل خفيف","ن هـ ج 7329","D-102","Test2","moving",42,61,38512,58.2,"east",3,289),
    makeCar("GPS-008","فورد ترانزيت 2024","مركبة توصيل","ر ي ض 4410","D-104","Test3","moving",68,84,17440,101.8,"north",4,156),
    makeCar("GPS-017","تويوتا كورولا 2023","مركبة ميدانية","ل س ن 8025","D-103","Test4","idle",0,47,29300,31.4,"airport",2,210),
    makeCar("GPS-041","نيسان أورفان 2021","نقل موظفين","ط ع ب 6139","D-102","Test5","disabled",0,28,62910,0,"central",5,44)
  ];
